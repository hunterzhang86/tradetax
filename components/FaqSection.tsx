...
const FAQS = [
  {
    q: "我的数据安全吗? 账单会传到服务器吗?",
    a: "不会。解析、计算、导出全部在浏览器本地完成, 账单数据不会离开你的设备, 你可以断网使用来验证。站点本身是纯静态文件托管, 不存在可接收账单数据的后端。需要说明的是: 本站使用 Google Analytics 做访问统计、Google AdSense 展示广告, 它们仅记录页面访问等聚合信息, 不接触、也无法读取你上传的账单内容。",
  },
  {
    q: "支持哪些券商和文件格式?",
